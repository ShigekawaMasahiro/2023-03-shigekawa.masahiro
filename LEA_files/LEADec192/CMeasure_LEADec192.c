...
int main(int argc, char *argv[]) {
  ...
  const unsigned int Cipher[] = {0x325eb96f, 0x871bad5a,0x35f5dc8c,0xf2c67476};
  const unsigned int Plain_Ans[] = {0x23222120, 0x27262524, 0x2b2a2928, 0x2f2e2d2c};

  // Check the result.
    unsigned int Plain[4] = {0};
    LEA_De_192(Plain, Cipher, Key_K);
