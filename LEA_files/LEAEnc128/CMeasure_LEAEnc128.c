...
int main(int argc, char *argv[]) {
  ...
  const unsigned int Plain[] = {0x13121110, 0x17161514, 0x1b1a1918, 0x1f1e1d1c};
  const unsigned int Cipher_Ans[] = {0x354ec89f, 0x18c6c628, 0xa7c73255, 0xfd8b6404};

  // Check the result.
    unsigned int Cipher[4] = {0};
    LEA_En_128(Plain, Cipher, Key_K);
